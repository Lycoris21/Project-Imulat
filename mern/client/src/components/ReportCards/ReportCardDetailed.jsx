...
const ReportCardDetailed = ({ report }) => (
    <Link
        ...
        className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl min-w-[18rem] max-w-[28rem] w-full flex-shrink-0 transition-all duration-300 transform hover:-translate-y-1 group"
    >
        {/* Cover Image */}
        ...
        <div className="p-4 sm:p-6">
            ...
            {/* AI Summary */}
            <p className="text-gray-600 text-xs sm:text-sm mb-3 sm:mb-4 line-clamp-3 min-h-[3rem] sm:min-h-[4rem]">
