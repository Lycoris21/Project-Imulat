        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end space-x-3">
            ...
            <button
              ...
              className="px-4 py-2 bg-[color:var(--color-dark)] text-white rounded-lg hover:bg-[color:var(--color-base)] disabled:opacity-50 disabled:cursor-not-allowed flex items-center cursor-pointer"
            >
              {loading ? (
                <>
