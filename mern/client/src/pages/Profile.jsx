        ...
        <div className="min-h-screen bg-base-gradient px-4 pt-[0rem] flex justify-center">
            <div className="w-[1000px] bg-white rounded shadow-xl pt-0 p-8">
                ...
                <div className="relative h-60 bg-cover bg-center rounded-sm mb-6" style={{
                    ...
                    <Link
                        to="/EditProfile"
                        className="absolute bottom-4 right-4 border-[0.5px] border-[#1E275E] bg-white text-[#1E275E] py-2 px-4 rounded hover:bg-[#1E275E] hover:text-white hover:border-white"
                    >
                        Edit Profile
                    </Link>

                    <div className="absolute -bottom-17 right-16 flex space-x-2">
                        <button className="bg-[#1E275E] text-white py-1 px-3 rounded hover:bg-[#4B548B] flex items-center cursor-pointer">
