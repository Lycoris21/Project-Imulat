            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="mb-8">
                    ...
                    <SearchBar
                        ...
                        isLoading={suggestionsLoading}
                        defaultSearchRoute={`/bookmarks/collection/${collectionId}`}
                    />
                                ...
                                {getReportsBookmarks().map((bookmark) => (
                                        <div key={`report-${bookmark.targetId._id}`} className="relative group">
                                            ...
                                            <button
                                                ...
                                                className="absolute -top-2 right-1 opacity-0 group-hover:opacity-100 transition-opacity bg-red-500 hover:bg-red-600 text-white rounded-full p-1"
